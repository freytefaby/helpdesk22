                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Editar Manual</h3>
                                ...
                                <div class="panel-body form-group-separated">
                                   {!!Form::model($post,['method'=>'PATCH','route'=>['admin.dashboard.update',$post->idpost],'class'=>'form-horizontal','files'=>'true'])!!}
					{{Form::token()}}
									<div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control select" name="categoria">
                                              <option value="">Seleccione  </option>
																...
																@if($post->idcategoria==$c->idcategoria)
																<option value="{{$c->idcategoria}}" selected>{{$c->categoriadesc}}</option>
															   @else
                                   	...
                                   	<div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Video / manual actualizar</label>
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                     ...
                                     <div class="form-group">                                        
                                        <label class="col-md-3 col-xs-12 control-label">Documento Actual</label>
                                        <div class="col-md-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">   
										 @if(Session::get('descripcion')=="")
                                            <textarea class="form-control" rows="5" name="descripcion">{{$post->descripcion}}</textarea>
										@else
                                ...
                                <div class="panel-footer">
									...
									<input type="hidden" name="video_source" value="{{$post->pdf_source}}">
									<input type="hidden" name="tipo_source" value="{{$post->tipo}}">
									</form>
                                </div>
                            </div>
