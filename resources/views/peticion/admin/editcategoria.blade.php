                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body form-group-separated">
                                   {!!Form::model($category,['method'=>'PATCH','route'=>['categoria.update',$category->idcategoria],'class'=>'form-horizontal'])!!}
					{{Form::token()}}
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-font"></span></span>
												 ...
												 <input type="text" class="form-control" name="categoria" value="{{$category->categoriadesc}}"/>
											
                                            </div>            
                                            <span class="help-block">Editar nueva categoria</span>
                                        </div>
                                    </div>
